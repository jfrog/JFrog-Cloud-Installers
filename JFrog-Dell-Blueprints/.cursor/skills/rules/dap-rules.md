...
- **Expect occasional false positives.** The linter may flag items that are actually correct. Use your judgement, but do not ignore findings without reviewing them.
