...
> For detailed YAML examples and the dynamic precreate script pattern, run {{PLUGINS_DOCS_BLOCK}}
...
> For detailed defining/consuming capability examples, run {{PLUGINS_DOCS_BLOCK}}
